...
MODELS = {
    ...
    'moco-v3': ['https://dl.fbaipublicfiles.com/moco-v3/r-50-300ep/r-50-300ep.pth.tar', 'pth'],
...
if __name__ == '__main__':
    ...
    if os.path.isfile('pretrained_models/byol.pkl'):
        # BYOL is provided in a pickle format, so we need to handle that first
        convert_byol('pretrained_models/byol.pkl', 'pretrained_models/byol.pth')
        os.remove('pretrained_models/byol.pkl')
    ...
    for model_name in MODELS:
        ...
        torch.save(state_dict, os.path.join('pretrained_models', f'{model_name}.pth'))
