...
def main(conf):	
	...
	train_img_dir = os.path.join(conf.data,'MontgomerySet/CXR_png')
	train_mask_dir = os.path.join(conf.data,'MontgomerySet/ManualMask')
	dataset_train = MontgomeryDataset_pretrain(train_img_dir,train_mask_dir,transforms = None)


	data_loader_train = torch.utils.data.DataLoader(dataset_train, batch_size=conf.batch_size, shuffle=True,
													num_workers=conf.workers)
	data_loader_valid = torch.utils.data.DataLoader(dataset_train, batch_size=conf.batch_size,
